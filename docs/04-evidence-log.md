...
| E-09 | S-05 ผู้ดูแลระบบ / เจ้าหน้าที่ IT | CT | ระบบต้องเก็บบันทึกประวัติการทำรายการ (Audit Log) ทุกขั้นตอน และไม่อนุญาตให้แก้ไขหรือลบ Log ย้อนหลังเพื่อความปลอดภัย | Security & Audit | High (Policy & Compliance) | E-03, E-08 | ออกแบบโครงสร้างตาราง Audit Log |
| E-10 | S-05 ผู้จัดการพื้นที่ | SN | ผู้บริหาร/ผู้จัดการต้องการดูสถิติตารางการจอง อัตราการใช้ห้อง และรายงานผู้ไม่มาตามนัด (No-show) บน Dashboard | Dashboard & Report | Medium (Simulation) | E-05, E-06 | ยืนยันข้อมูลฟิลด์รายงานที่ต้องการ |
...
| C-03 | บทลงโทษกรณี No-show ติดต่อกันหลายครั้ง (E-06, E-10) | ผู้จัดการพื้นที่ vs นักศึกษา | ผู้จัดการต้องการตัดสิทธิ์ทันที แต่นักศึกษาขอให้ตักเตือนก่อน | ความเป็นระเบียบของนโยบาย vs ความยืดหยุ่นต่อผู้ใช้งาน | Decided |
...
| **C-03** | A: ตัดสิทธิ์การจองทันที 7 วัน<br>B: เตือนผ่านระบบก่อนครบ 3 ครั้ง แล้วค่อยระงับสิทธิ์ 7 วัน | Compliance / Fairness | **Decided** (เลือก B) | ทางเลือก B ช่วยป้องกันกรณีเกิดเหตุสุดวิสัย และเพิ่มความโปร่งใสโดยแสดงสถิติเตือนบนหน้าเว็บผู้ใช้ (E-06, E-10) | ออกแบบระบบนับจำนวน No-show ในฐานข้อมูล |
...
| **RC-08** | ระบบต้องบันทึกประวัติการดำเนินงาน (Audit Log) ทุกขั้นตอน ทั้งการสร้างคำขอ การอนุมัติ การยกเลิก และการส่งมอบอุปกรณ์ โดยไม่อนุญาตให้แก้ไข Log ย้อนหลัง | เพิ่มความปลอดภัย ความโปร่งใส และการตรวจสอบย้อนหลัง | E-09 | Candidate | High | ยืนยันโครงสร้างตาราง Audit Log และสิทธิ์การเข้าถึง |
| **RC-09** | ระบบต้องมีหน้า Dashboard แสดงรายงานสถิติการใช้งานห้อง อัตราการยืมอุปกรณ์ และประวัติ No-show สำหรับผู้บริหาร | เพื่อสนับสนุนการตัดสินใจและวางแผนจัดสรรงบประมาณ | E-10 | Candidate | Medium | ยืนยันรูปแบบ กราฟ/ตาราง บน Dashboard |
